...
public class CheckEpamUserLoginTest extends GeneralWebDriver {
    ...
    public void setWebDriver() {
        ...
        webDriver.navigate().to(com.epam.tc.hw2.ex1.ConfProperties.getProperty("url"));
    }
    ...
    public void testExistUserLogin() {
        ...
        webDriver.findElement(By.id("name")).sendKeys(com.epam.tc.hw2.ex1.ConfProperties.getProperty("username"));
